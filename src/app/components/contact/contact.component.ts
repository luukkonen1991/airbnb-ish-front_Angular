...
export class ContactComponent implements OnInit {
  ...
  onSubmit() {
    this.contactService.sendMessage(this.contactMessage.data.name, this.contactMessage.data.email, this.contactMessage.data.phone, this.contactMessage.data.message).subscribe(
      res => {
        if (res.success === true) {
